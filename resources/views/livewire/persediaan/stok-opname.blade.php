                        ...
                        <table class='tw-w-full tw-table-auto'>
                            ...
                            <tbody>
                                ...
                                <tr class='text-center'>
                                    ...
                                    <td class='tw-whitespace-nowrap text-left'>{{ $result['buku'] }}</td>
                                    <td class='tw-whitespace-nowrap text-left'>{{ $result['fisik'] }}</td>
                                    <td class='tw-whitespace-nowrap text-left'>{{ $result['selisih'] }}</td>
