...
class Produk extends Component
{
    ...
    public function render()
    {
        ...
        $data = DB::table('produk')->select('produk.id', 'produk.id_cabang', 'produk.nama_item', 'produk.harga_jasa', 'produk.komisi', 'produk.stock', 'produk.deskripsi', 'produk.gambar', 'kategori_produk.nama_kategori', 'kategori_satuan.nama_satuan')
