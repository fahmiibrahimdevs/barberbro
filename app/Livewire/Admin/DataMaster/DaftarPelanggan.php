...
class DaftarPelanggan extends Component
{
    ...
    public function render()
    {
        ...
        $data = DB::table('daftar_pelanggan')->select('daftar_pelanggan.id', 'daftar_pelanggan.nama_pelanggan', 'daftar_pelanggan.no_telp', 'daftar_pelanggan.deskripsi', 'daftar_pelanggan.gambar', 'users.name')
