...
class DaftarKaryawan extends Component
{
    ...
    public function render()
    {
        ...
        $data = DB::table('daftar_karyawan')->select('daftar_karyawan.id', 'daftar_karyawan.role_id', 'cabang_lokasi.nama_cabang', 'users.name', 'users.email', 'daftar_karyawan.deskripsi', 'daftar_karyawan.no_telp')
